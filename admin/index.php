...
function AddEditIndexForm($IndexId, $Action, $FormTitle, $titlevalue, $weightvalue, $urlvalue, $permittedgroups, $zone01value, $zone02value, $zone03value, $zone04value, $zone05value, $zone06value, $zone07value, $zone08value, $zone09value, $zone10value , $LabelSubmitButton, $pid, $visiblevalue)
{
	...
	if($urlvalue) {$urlvalue = $urlvalue;} else { $urlvalue = $xoopsModuleConfig['defaulturl'] ;}
...
if ($xoopsModuleConfig['columnvisibility01']){
	if ($zone01value){
				$sform->addElement(new XoopsFormTextArea($xoopsModuleConfig['columnname01'], 'zone01', $zone01value, 3, 16), false);
				} else {
				$sform->addElement(new XoopsFormTextArea($xoopsModuleConfig['columnname01'], 'zone01', $xoopsModuleConfig['columndefault01'], 3, 16), false);}}

if ($xoopsModuleConfig['columnvisibility02']){
	if ($zone02value){
				$sform->addElement(new XoopsFormTextArea($xoopsModuleConfig['columnname02'], 'zone02', $zone02value, 3, 16), false);
				} else {
				$sform->addElement(new XoopsFormTextArea($xoopsModuleConfig['columnname02'], 'zone02', $xoopsModuleConfig['columndefault02'], 3, 16), false);}}


if ($xoopsModuleConfig['columnvisibility03']){
	if ($zone03value){
				$sform->addElement(new XoopsFormTextArea($xoopsModuleConfig['columnname03'], 'zone03', $zone03value, 3, 16), false);
				} else {
				$sform->addElement(new XoopsFormTextArea($xoopsModuleConfig['columnname03'], 'zone03', $xoopsModuleConfig['columndefault03'], 3, 16), false);}}


if ($xoopsModuleConfig['columnvisibility04']){
	if ($zone04value){
				$sform->addElement(new XoopsFormTextArea($xoopsModuleConfig['columnname04'], 'zone04', $zone04value, 3, 16), false);
				} else {
				$sform->addElement(new XoopsFormTextArea($xoopsModuleConfig['columnname04'], 'zone04', $xoopsModuleConfig['columndefault04'], 3, 16), false);}}


if ($xoopsModuleConfig['columnvisibility05']){
	if ($zone05value){
				$sform->addElement(new XoopsFormTextArea($xoopsModuleConfig['columnname05'], 'zone05', $zone05value, 3, 16), false);
				} else {
				$sform->addElement(new XoopsFormTextArea($xoopsModuleConfig['columnname05'], 'zone05', $xoopsModuleConfig['columndefault05'], 3, 16), false);}}


if ($xoopsModuleConfig['columnvisibility06']){
	if ($zone06value){
				$sform->addElement(new XoopsFormTextArea($xoopsModuleConfig['columnname06'], 'zone06', $zone06value, 3, 16), false);
				} else {
				$sform->addElement(new XoopsFormTextArea($xoopsModuleConfig['columnname06'], 'zone06', $xoopsModuleConfig['columndefault06'], 3, 16), false);}}


if ($xoopsModuleConfig['columnvisibility07']){
	if ($zone07value){
				$sform->addElement(new XoopsFormTextArea($xoopsModuleConfig['columnname07'], 'zone07', $zone07value, 3, 16), false);
				} else {
				$sform->addElement(new XoopsFormTextArea($xoopsModuleConfig['columnname02'], 'zone07', $xoopsModuleConfig['columndefault07'], 3, 16), false);}}


if ($xoopsModuleConfig['columnvisibility08']){
	if ($zone08value){
				$sform->addElement(new XoopsFormTextArea($xoopsModuleConfig['columnname08'], 'zone08', $zone08value, 3, 16), false);
				} else {
				$sform->addElement(new XoopsFormTextArea($xoopsModuleConfig['columnname08'], 'zone08', $xoopsModuleConfig['columndefault08'], 3, 16), false);}}


if ($xoopsModuleConfig['columnvisibility09']){
	if ($zone09value){
				$sform->addElement(new XoopsFormTextArea($xoopsModuleConfig['columnname09'], 'zone09', $zone09value, 3, 16), false);
				} else {
				$sform->addElement(new XoopsFormTextArea($xoopsModuleConfig['columnname09'], 'zone09', $xoopsModuleConfig['columndefault09'], 3, 16), false);}}


if ($xoopsModuleConfig['columnvisibility10']){
	if ($zone10value){
				$sform->addElement(new XoopsFormTextArea($xoopsModuleConfig['columnname10'], 'zone10', $zone10value, 3, 16), false);
				} else {
				$sform->addElement(new XoopsFormTextArea($xoopsModuleConfig['columnname10'], 'zone10', $xoopsModuleConfig['columndefault10'], 3, 16), false);}}
    ...
    default:
		...
		if (count($indexarray) >0) {
        	foreach($indexarray as $index) {
				...
				echo "<tr class='".$class."'><td align='center'>" . $index->indexid() . "</td><td align='left'>" . $whitespace.'&nbsp;'.$index->title(). $whitespace2 ."</td><td align='center'>" . $index->created() . "</td><td align='center'>" . $index->modified() . "</td><td align='right'>" . $index->weight() . "</td><td align='center'><img src='../images/icon/" . $visible . ".gif'></td><td align='center'>" . $action_edit . "&nbsp;|&nbsp;" . $action_delete . "</td></tr>\n";
